...
let LoginPage = class LoginPage extends _base_base_service_injector__WEBPACK_IMPORTED_MODULE_4__["BaseWithInjectorServiceComponent"] {
    constructor(formBuilder, firestore, firebaseAuth) {
        super();
        this.formBuilder = formBuilder;
        this.firestore = firestore;
        this.firebaseAuth = firebaseAuth;
        this.backgroundImage = 'assets/img/bgimage.jpg';
    ...
    onLoginSuccess(accessToken, accessSecret) {
        ...
        const credential = accessSecret ? firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"].GoogleAuthProvider
            .credential(accessToken, accessSecret) : firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"].GoogleAuthProvider
    ...
    signInWithUserCredentials() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!this.signInForm.valid) {
                ...
                this.storage.clear();
                this.globalService.showLoading();
                yield this.firebaseAuth.auth.signInWithEmailAndPassword(this.signInForm.value.email, this.signInForm.value.password)
                    .then((data) => {
                    if (data == null) {
...
], LoginPage.prototype, "signInForm", void 0);
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__["AngularFirestore"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_5__["AngularFireAuth"]])
], LoginPage);
